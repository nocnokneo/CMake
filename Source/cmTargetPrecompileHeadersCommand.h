...
public:
  ...
  virtual cmCommand* Clone()
    {
    return new cmTargetPrecompileHeadersCommand;
    }
   ...
   */
  virtual std::string GetName() const { return "target_precompile_headers";}

  cmTypeMacro(cmTargetPrecompileHeadersCommand, cmTargetPropCommandBase);
