...
.. versionchanged:: 3.32
  ...
  When using the :option:`--repeat <ctest --repeat>` option, the behavior of
  fixture setup and cleanup tests is controlled by the
  :prop_test:`FIXTURE_REPEAT_MODE` property and the :policy:`CMP0210` policy.
